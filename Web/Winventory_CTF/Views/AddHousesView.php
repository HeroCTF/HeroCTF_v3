...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title Page-->
        <title>Winventory - Add House</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Winventory - Add House</a>
    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="?page=validNewHouse">
                    ...
                    <div>
                        <button class="btn btn--radius-2 btn--red" type="submit">Add new house</button>
                    </div>
                    </form>
                </div>
            </div>
