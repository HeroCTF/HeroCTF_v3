...
<head>
    ...
    <!-- Title Page-->
    <title>Winventory - Delete my account</title>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="?page=delete">Delete my account <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="?page=validDelete" id="deleteForm">
                    ...
                    ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="password" name="repeat_password" required>
                                </div>
                            </div>
                        </div>
                        <div>
                            <button class="btn btn--radius-2 btn--red" type="submit">Delete my profile.</button>
                        </div>
                    </form>
                </div>
            </div>
